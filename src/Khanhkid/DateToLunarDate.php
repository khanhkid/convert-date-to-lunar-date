...
class DateToLunarDate
{
    ...
    {
        $arr2 = ['Tháng Giêng', 'Tháng Hai', 'Tháng Ba', 'Tháng Tư', 'Tháng Năm', 'Tháng Sáu', 'Tháng Bảy', 'Tháng Tám', 'Tháng Chín', 'Tháng Mười', 'Tháng Mười Một', 'Tháng Chạp'];
    ...
    {
        return ['Giáp', 'Ất', 'Bính', 'Đinh', 'Mậu', 'Kỷ', 'Canh', 'Tân', 'Nhâm', 'Quí'];
    }
    ...
    {
        $arr = ['110100101100', '001101001011', '110011010010', '101100110100', '001011001101', '010010110011'];
